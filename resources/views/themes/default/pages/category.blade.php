            ...
            <div class="full-width_border border-2" style="border-color: #f5e6e0;">
                <div class="shop-banner position-relative ">
                    ...
                    <div class="shop-banner__content container position-absolute start-50 top-50 translate-middle">
                        <h2 class="h1 text-uppercase text-center fw-bold ">{{ $category->category_name }}</h2>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="shop-list flex-grow-1 mb-3 mb-md-4">
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
                        ...
                        <a class="menu-link menu-link_us-s text-uppercase fw-medium">{{ $category->category_name }}</a>
                    </div><!-- /.breadcrumb -->
...
@section('script')
    <script>
        var fetchProductsUrl = "{{ route('front.category', ['slugs' => $category->slugs]) }}";
        ...
        $(document).ready(function() {
            ...
            $('#search-products').on('keyup', function() {
                ...
                searchCategoryTimeout = setTimeout(fetchProducts, 500); // 500ms delay
            });
        });
    </script>
@endsection
